...
function PatientRegistration(){
  ...
  const [patient,setPatient]=useState({
    ...
    const register = (e) =>{
      ...
      fetch("http://localhost:8080/patient/register", requestOptions)
        ...
        .then(res => {
          ...
          if("id" in res)
          {
              toast.success('Patient Registered Successfully (Unique patient id: '+res.id+')'); 
          } 
          else
          {
    ...
    return(
        ...
                  <label htmlFor="female">Female</label>
                  ...
                  <div className="col-75"><input type="text" className="in"
                  value={patient.mothersName} required
